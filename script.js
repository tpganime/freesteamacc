const items = [
  ...
  {title:"Cyberpunk 2077", image:"https://share.google/images/TGwzhQE9a0AoVMWlt", id:"", password:"aegis084"},
  {title:"GTA V", image:"https://share.google/images/VCY82Q7iYU9ZeqLHV", id:"", password:"Xbox_360!"},
...
items.forEach(item => {
  ...
  card.innerHTML = `
    ...
    <div class="info">
      ...
      <div class="credentials">
        <input type="text" value="${item.id}" readonly placeholder="No ID">
        <input type="text" value="${item.password}" readonly placeholder="No Password">
        <button>Copy</button>
      </div>
    </div>
  `;
  ...
  btn.onclick = () => {
    ...
    const text = Array.from(inputs).map(i => i.value).filter(v=>v).join(" / ");
